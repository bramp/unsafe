...
public class UnrolledCopierBenchmark {
    ...
    public final static int COPY_STRIDE = 8;

    abstract static class UnsafeState {
        final static Unsafe unsafe = UnsafeHelper.getUnsafe();

        // Must be multiple of COPY_STRIDE
        final static long destOffset = UnsafeHelper.firstFieldOffset(FourLongs.class);
        final static long destSize = UnsafeHelper.sizeOf(FourLongs.class) - destOffset;
        ...
        public void cleanupMemory() {
            ...
            Preconditions.checkState(new FourLongs(1,2,3,4).equals(dest), "Incorrect test object: %s", dest);
        }
        ...
        public void setup() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            copier = new UnsafeCopier(unsafe) {
                ...
                public void copy(Object dest, long src) {
                    ...
                    unsafe.putLong(dest, dstOffset, unsafe.getLong(src));
                    dstOffset += COPY_STRIDE; src += COPY_STRIDE;
    ...
    @State(Scope.Thread)
    public static class DuffState extends UnsafeState {
        ...
        public void setup() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
            ...
            copier = new UnrolledUnsafeCopier(unsafe) {

                @Override
                public void copy(Object dest, long dstOffset, long src) {
    ...
    */
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(UnrolledCopierBenchmark.class.getSimpleName())
